...
class ChangeTextTest {
    ...
    private val emptyToSet = "   "
    private val newWord = "Hello world"
...
//    }
    ...
    fun testEmptyText() {
        ...
        device.findObject(By.res(packageName, "userInput")).text = emptyToSet
        device.findObject(By.res(packageName, "buttonChange")).click()
    ...
    fun testNewText() {
        ...
        device.findObject(By.res(packageName, "userInput")).text = newWord
        device.findObject(By.res(packageName, "buttonActivity")).click()

        waitForPackage(packageName)

        val result = device.findObject(By.res(packageName, "text")).text
        assertEquals(result, newWord)
